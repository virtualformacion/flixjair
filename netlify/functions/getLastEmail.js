...
// Función sleep para esperar de manera asíncrona
function sleep(ms) {
...
exports.handler = async (event) => {
  try {
    ...
    for (let msg of response.data.messages) {
      ...
      // Verificar si es un correo de Netflix
      if (
        toHeader &&
        toHeader.value.toLowerCase().includes(email.toLowerCase()) &&
...
// Función para obtener el cuerpo del mensaje de Disney+
...
// Función para obtener el cuerpo del mensaje de Netflix
...
// Función para extraer los enlaces
